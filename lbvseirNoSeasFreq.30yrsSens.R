...
hypercube=randomLHS(n=nspaces, k=12) ## function with N columns
...
#  epsilon= 1/10,				# rate of aging for those juveniles, should be ~ annual
  ...
  k=0.004109589/2,        			# nb this is birth rate which halved
...
dimnames(nonVarying)[[2]]=c("omega","epsilon","SUSJ.0","MDAJ.0","SUSJM.0","EIJ.0",
...
dimnames(fullParamSets)[[2]]=c("OMEGA","EPSILON","SUSJ.0","MDAJ.0","SUSJM.0",
                               "EIJ.0",
                               "ERJ.0","INFJ.0","RECJ.0","SUSA.0",
